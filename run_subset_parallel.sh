...
run_job() {
    ...
    # We use FLOW_VARIANT to ensure separate output directories
...
echo "=== Starting Specific Nangate45 Jobs (1x and 0.85x) ==="
# List of specific designs: bp_fe_top, bp_be_top, bp_multi_top, tinyRocket
# Note: bp_quad is excluded per instructions.
for design in bp_fe_top bp_be_top bp_multi_top tinyRocket; do
    # Run 1x (Standard)
