...
| <a name="GPL_SOFT_PLACEMENT_CLUSTERS_ENABLE"></a>GPL_SOFT_PLACEMENT_CLUSTERS_ENABLE| Enables reading placement cluster guidance from an external CSV soft-assignment file via OpenROAD `read_soft_placement_clusters`.| 0|
...
- [GPL_SOFT_PLACEMENT_CLUSTERS_ENABLE](#GPL_SOFT_PLACEMENT_CLUSTERS_ENABLE)
