...
# Narrower metal7 straps reduce remaining-channel PDN repair failures for ng45 testcases.
add_pdn_stripe -grid {grid} -layer {metal7} -width {0.90} -pitch {30.0} -offset {2}
